...
D1_schema = { 
 'area_classifications': {'rel_path': '*.areaClassifications.csv',
  'minimum_size': 611.2},
 'beh_cam_json': {'rel_path': '*.behavior.json', 'minimum_size': 696.0},
 'behavior_stimulus': {'rel_path': '*.behavior.pkl',
  'minimum_size': 18426323.2},
 'behavior_tracking': {'rel_path': '*.behavior.mp4',
  'minimum_size': 1956597323.2},
 'EcephysBrainSurfaceLeft': {'rel_path': '*_surface-image2-left.png',
  'minimum_size': 1311537.6},
 'EcephysBrainSurfaceRight': {'rel_path': '*_surface-image2-right.png',
  'minimum_size': 1316493.6},
 'ephys_raw_data_probe_A': {'rel_path': '*probeABC\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'ephys_raw_data_probe_B': {'rel_path': '*probeABC\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'ephys_raw_data_probe_C': {'rel_path': '*probeABC\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'ephys_raw_data_probe_D': {'rel_path': '*probeDEF\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'ephys_raw_data_probe_E': {'rel_path': '*probeDEF\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'ephys_raw_data_probe_F': {'rel_path': '*probeDEF\\*recording*npx2',
  'minimum_size': 407750128435.2},
 'eye_cam_json': {'rel_path': '*.eye.json', 'minimum_size': 689.6},
 'eye_tracking': {'rel_path': '*.eye.mp4', 'minimum_size': 1956543098.4},
 'face_cam_json': {'rel_path': '*.face.json',
  'minimum_size': 690.4000000000001},
 'face_tracking': {'rel_path': '*.face.mp4', 'minimum_size': 1955874822.4},
 'fiducial_image': {'rel_path': '*.fiducial.png', 'minimum_size': 1606833.6},
 'EcephysInsertionLocationImage': {'rel_path': '*.insertionLocation.png',
 ...
 'EcephysOverlayImage': {'rel_path': '*.overlay.png', 'minimum_size': 542164.0},
...
#  'minimum_size': 1339092.8},
 'EcephysPostExperimentLeft': {'rel_path': '*_surface-image6-left.png',
  'minimum_size': 1308762.4000000001},
 'EcephysPostExperimentRight': {'rel_path': '*_surface-image6-right.png',
  'minimum_size': 1321449.6},
 'EcephysPostInsertionLeft': {'rel_path': '*_surface-image4-left.png',
  'minimum_size': 1376120.0},
 'EcephysPostInsertionRight': {'rel_path': '*_surface-image4-right.png',
  'minimum_size': 1391095.2000000002},
 'EcephysPostStimulusLeft': {'rel_path': '*_surface-image5-left.png',
  'minimum_size': 1382569.6},
 'EcephysPostStimulusRight': {'rel_path': '*_surface-image5-right.png',
  'minimum_size': 1393450.4000000001},
 'EcephysPreExperimentLeft': {'rel_path': '*_surface-image1-left.png',
  'minimum_size': 1400624.0},
 'EcephysPreExperimentRight': {'rel_path': '*_surface-image1-right.png',
  'minimum_size': 1421704.0},
 'EcephysPreInsertionLeft': {'rel_path': '*_surface-image3-left.png',
  'minimum_size': 1334457.6},
 'EcephysPreInsertionRight': {'rel_path': '*_surface-image3-right.png',
  'minimum_size': 1339092.8},
 'replay_stimulus': {'rel_path': '*.replay.pkl',
  'minimum_size': 27547471.200000003},
 'surgery_notes': {'rel_path': '*_surgeryNotes.json', 'minimum_size': 1314.4},
 'synchronization_data': {'rel_path': '*.sync', 'minimum_size': 74143171.2},
 'visual_stimulus': {'rel_path': '*.mapping.pkl',
