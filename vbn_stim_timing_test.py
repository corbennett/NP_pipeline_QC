...
syncDataset = Dataset(r"C:\Users\svc_ccg\Desktop\VBN_timing_test\20220510T175349.h5")
...
behavior_stim_table = build_stim_tables.generate_behavior_stim_table(behavior_data, syncDataset)
...
mapping_stim_table = build_stim_tables.generate_mapping_stim_table(mapping_data_stimuli, syncDataset, 1, behavior_data['items']['behavior']['intervalsms'].size+1)
