...
plot_diode(passive_stim_table.start_time.values, diodeData, axes[2], ['center', 'top'], 'passive_stim')
...
for ix, x in enumerate(xs):
    for iy, y in enumerate(ys):
        rfdf = rf_stim_table.loc[(rf_stim_table['position_x']==x)&(rf_stim_table['position_y']==y)]
